...
| D8 | Sem sequence packing na v1; usar `group_by_length` | Packing multi-exemplo exige máscara de atenção por segmento para não vazar contexto entre exemplos; complexidade adiada | **[HIPÓTESE]** |
